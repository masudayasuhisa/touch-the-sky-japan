          ...
          <div className="program-flex">
            ...
            <div className="timeline">
              ...
              <div className="timeline-item animate-up" style={{transitionDelay: '0.4s'}}>
                ...
                <p>Learn the foundations of trail running—uphill power hiking, downhill technique, pacing, and safety. Enjoy easy-paced runs/walks through Myoko's lush forests and foothills. Spend afternoons recovering with open-air hot springs, coffee roasting, and traditional Sasa-dango sweet crafting.</p>
              </div>
